$(document).ready(function () {
    if(!$("#id_funcionario_issem").is(":checked") == true){
        $(".funcionario_issem_hidden").css("display", "none");
    }
...
$('#id_funcionario_issem').click(function () {
    if($(".funcionario_issem_hidden").is(":hidden")){
        $(".funcionario_issem_hidden").css("display", "inline");
    }else{
        $(".funcionario_issem_hidden").css("display", "none");
    }
});
